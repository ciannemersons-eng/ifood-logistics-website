      ...
      <Container>
        ...
        <ol className="mt-14 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5 lg:gap-6">
          {content.steps.map((step, index) => (
            <li key={step.id} className="relative flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <span className="relative z-10 flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-ifood-darkBlue font-display text-lg font-bold text-white">
                {step.stepNumber}
              </span>
